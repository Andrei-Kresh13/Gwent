...
import com.example.gwent.logic_game.cards.commands.cards.CardsHelper;
import com.example.gwent.logic_game.cards.commands.cards.Pile;
import com.example.gwent.logic_game.cards.commands.core.ResetGameDataCommand;
import com.example.gwent.logic_game.cards.commands.core.ShufflePileAtPositionCommand;
...
public class PrepareGameSessionCommand extends BaseSessionCommand {
    ...
    public void execute() {
        ...
        addStockPileCommand.setCards(CardsHelper.create13Deck());
